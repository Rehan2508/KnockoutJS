...
//return true for observables, observableArrays, and all computed observables.
console.log(ko.isObservable(firstName));
console.log(ko.isWriteableObservable(firstName));
//returns true for observable, observableArrays, and writable computed observables.
